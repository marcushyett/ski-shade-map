  ...
  return (
    <span role="img" aria-label="snowflake" style={style}>
      <svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor">
        <path
          d="M12 2v4m0 12v4M2 12h4m12 0h4M4.93 4.93l2.83 2.83m8.48 8.48l2.83 2.83M4.93 19.07l2.83-2.83m8.48-8.48l2.83-2.83M12 8a4 4 0 100 8 4 4 0 000-8z"
          stroke="currentColor"
          strokeWidth="2"
          fill="none"
          strokeLinecap="round"
    ...
    >
      ...
      >
        <ConditionIcon
          ...
          style={{ fontSize: style.iconSize, color: info.color }}
        />
        {showScore && (
        ...
        {showLabel && <span style={{ color: "#ccc" }}>{info.label}</span>}
      </span>
    </Tooltip>
  );
}
...
export function SnowScoreIndicator({
  score,
  condition,
}: {
  score: number;
